...
async def init_upload(
    ...
    idem: Annotated[IdempotencyCheck, Depends(require_idempotency("media.upload.init"))],
) -> Any:
...
async def get_download_url(
    ...
    return success_response(DownloadUrlResponse(download_url=url, expires_in=expires_in))
