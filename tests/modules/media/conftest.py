...
async def pending_media(
    ...
    media = MediaFile(
        ...
        storage_key=(f"{institution.id}/originals/2026/04/{uuid.uuid4()}.jpg"),
...
async def completed_media(
    ...
    media = MediaFile(
        ...
        storage_key=(f"{institution.id}/originals/2026/04/{uuid.uuid4()}.pdf"),
...
async def foreign_media(
    ...
    media = MediaFile(
        ...
        file_size=4096,
        mime_type="application/pdf",
        storage_key=(f"{foreign_institution.id}/originals/2026/04/{uuid.uuid4()}.pdf"),
        upload_status="completed",
    )
    db_session.add(media)
    await db_session.flush()
